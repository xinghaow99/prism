...
class AutoencoderKLCausal3D(ModelMixin, ConfigMixin, FromOriginalVAEMixin):
    ...
    def __init__(
        ...
        self.tile_sample_min_tsize = min(sample_tsize, 16)  # Limit temporal tile for single-GPU memory
        self.tile_latent_min_tsize = self.tile_sample_min_tsize // time_compression_ratio
